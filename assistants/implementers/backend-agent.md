...
1. **Route file** (e.g., `routes/products.routes.ts`)
2. **Controller file** (e.g., `controllers/product.controller.ts`)
3. **Service file** (e.g., `services/product.service.ts`)
4. **Validation schemas** (if using Zod/Joi)
5. **Test file** (e.g., `controllers/product.controller.test.ts`)
