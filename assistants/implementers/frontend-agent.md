...
### 1. Component File (e.g., `ComponentName.tsx`)
- Component implementation
- TypeScript interfaces/types
- Proper exports

### 2. Style File (e.g., `ComponentName.css` or `ComponentName.styles.ts`)
- CSS or styled-components
- Responsive design
- Design system tokens
- BEM naming or CSS-in-JS

### 3. Test File (e.g., `ComponentName.test.tsx`)
- Unit tests for component logic
- Integration tests for user interactions
- Accessibility tests
- Edge case coverage

### 4. Index File (e.g., `index.ts`)
- Clean exports
