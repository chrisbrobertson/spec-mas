...
1. **Entity/Model file** (e.g., `entities/product.entity.ts` or `schema.prisma`)
2. **Migration file** (e.g., `migrations/1699900000000-CreateProductsTable.ts`)
3. **Seed file** (optional, for test data)
4. **Migration test file** (e.g., `migrations/product.migration.test.ts`)
