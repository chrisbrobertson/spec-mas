...
**AI-Coord Patterning:**
- Spec‑MAS can model CLI tool detection and role‑based invocation after ai‑coord’s registry patterns.
- Lead/validator roles map to equivalent permission profiles without requiring direct compatibility.
