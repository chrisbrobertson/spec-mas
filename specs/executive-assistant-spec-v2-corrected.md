...
version: 1.1.0
checksum: e7d4c8b9a3f2e1d6c5b4a3f2e1d0c9b8a7f6e5d4c3b2a1f0e9d8c7b6a5f4e3d2
created: 2025-10-25
updated: 2025-10-25
owners:
  - name: Executive User
...
```json
{
  ...
  "input": {
    "content": "URGENT: Need approval on contract ASAP before end of day",
    "source_type": "slack"
  },
...
```json
{
  ...
  "input": {
    "ask": "Can you review the document?",
    "commitment": "I'll have it done by tomorrow",
    "action": "Document reviewed and comments added",
    "thread_context": "same_email_thread"
  },
...
```json
{
  ...
  "input": {
    "content": "FYI - The office will be closed next Monday for the holiday.",
    "source_type": "email"
  },
...
```json
{
  ...
  "input": {
    "content": "John: I'll take the lead on this. Sarah: I can help with the analysis. Mike: I'll review the final draft.",
    "source_type": "zoom",
...
**Story 4:** As an executive, I want to search for any item by keyword or person, so that I can quickly find what I'm looking for.
...
- [ ] Given "urgent" keyword, When AI processes, Then priority set to "high"
