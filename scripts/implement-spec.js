...
function loadAgentPrompt(agentType) {
  const promptPath = path.join(__dirname, '../assistants/implementers', `${agentType}-agent.md`);
...
## Output Format
Please provide your implementation with clear file paths using this format:
...
Generate all necessary files for this task.
`;
}
