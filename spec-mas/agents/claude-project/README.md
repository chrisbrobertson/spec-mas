...
| `architecture-analysis-guide.md` | Required | Architecture analysis and spec splitting guidance |
| `validation-integration-guide.md` | Required | Validation process and syntax checking |
...
- [ ] Upload `architecture-analysis-guide.md` to project knowledge
- [ ] Upload `validation-integration-guide.md` to project knowledge
...
/analyze              # Perform architecture analysis (check if spec should be split)
...
- **Architecture Analysis** - Detects when specs are too large and recommends splitting
- **Syntax Validation** - Ensures specs are syntactically correct before completion
...
- ✅ Specs are appropriately scoped (not too large)
